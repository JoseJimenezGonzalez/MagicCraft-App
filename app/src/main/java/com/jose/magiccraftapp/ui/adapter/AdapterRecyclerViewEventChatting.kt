...
class AdapterRecyclerViewEventChatting (private var usersList: MutableList<MessageEvent>): RecyclerView.Adapter<AdapterRecyclerViewEventChatting.ViewHolder>() {
