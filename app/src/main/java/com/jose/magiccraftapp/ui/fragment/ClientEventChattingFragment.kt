...
import com.jose.magiccraftapp.databinding.FragmentClientEventChattingBinding
import com.jose.magiccraftapp.ui.adapter.AdapterRecyclerViewEventChatting
import java.text.SimpleDateFormat
import java.util.Calendar

class ClientEventChattingFragment : Fragment() {

    private var _binding: FragmentClientEventChattingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentClientEventChattingBinding.inflate(inflater, container, false)
        return binding.root
    }
