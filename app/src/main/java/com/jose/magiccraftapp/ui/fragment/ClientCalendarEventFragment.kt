...
import com.jose.magiccraftapp.databinding.FragmentClientCalendarBinding
...
class ClientCalendarEventFragment : Fragment() {

    private var _binding: FragmentClientCalendarEventBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentClientCalendarEventBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.e("ClientCalendarEventFragment", fechaString)
        //Actualizamos la ui
    ...
    private fun handleItemClick(event: Event) {
        ...
        findNavController().navigate(R.id.action_clientCalendarEventFragment_to_clientEventChattingFragment)
    }
